...
var knownProviders = require('./providers');
...
module.exports = function(options) {
  options = _.defaults(options || {}, {
    ...
    providers: {} // supported oauth providers that users can login to this app with
  });

  if (_.isEmpty(options.providers))
  ...
  return function(req, res, next) {
    ...
    debugger;
    var pathParts = urlParse(req.originalUrl).pathname.split('/');
    ...
    var provider = options.providers[providerName];
    if (!provider) {
